 ...
 // Processing the queries
   for (int i = 0; i < q; i++) {
       ...
       if(lvl_n1!=lvl_n2)
        ...
        if(node1==node2)
        {
            //mtlb staright hai is waqt v distance nikal lo
            int dist=lvl_n1-lvl[node1]+lvl_n2-lvl[node1];//kyuki lvl[node1] is level of the lca wala node
            cout<<dist<<" ";
            ...
            int lcaa=find_par(node1,1);
             int dist=lvl_n1-lvl[lcaa]+lvl_n2-lvl[lcaa];
            cout<<dist<<" ";
        }
